...
dt_egna_30d_std = load_data('egna', 30).round(2)
...
dt_jade_30d_std = load_data('jade_', 30, sep=' ').round(2)
...
dt_cmaes_30d_std = load_data('cmaes_prueba', 30).round(2)
...
dt_speda_30d_std = load_data('speda', 30).round(2)
...
dt_emna_30d_std = load_data('emna', 30).round(2)
