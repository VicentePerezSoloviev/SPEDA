...
from benchmarks import rastrigins_function
...
eda = SpEDA(alpha=0.7, max_it=1000, dead_it=150, size_gen=200, cost_function=rastrigins_function, vector=initial_vector)
